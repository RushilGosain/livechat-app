  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center chat-bg p-8 h-full">
      <div className="max-w-sm text-center space-y-6">
        ...
        {/* Text */}
        <div>
          <h2 className="text-2xl font-bold">Welcome to RushilChatt, {firstName}! 👋</h2>
          <p className="text-muted-foreground mt-2 text-sm leading-relaxed">
            Pick a conversation from the left or start a new one. Your messages update in real time — no refresh needed.
          </p>
        </div>
